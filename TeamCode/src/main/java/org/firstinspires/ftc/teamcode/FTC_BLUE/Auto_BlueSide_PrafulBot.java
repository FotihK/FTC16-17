...
public class Auto_BlueSide_PrafulBot extends LinearOpMode {
    ...
    protected int alliance = 1;                   //1 for red, -1 for blue
    ...
    protected void pressBlue(){                                 //These two seem opposite, it's pressing the color stated to change it to the other
